...
def get_urls_empleos(num):
    ...
    url = 'https://mx.computrabajo.com/trabajo-de-programador-python/?p={}'.format(
        num)
    headers = {
    ...
    # List of urls
    lista_url_empleos = ['https://www.computrabajo.com.mx' +
...
def data_retrieval(url):
    ...
    filename = f"mexico/vacantes/{id_job_by_url}-{fecha_busqueda}.json"

    # Create folder
    if not os.path.exists('mexico/vacantes'):
        os.makedirs('mexico/vacantes')
